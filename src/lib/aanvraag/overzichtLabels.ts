...
export const VELD_LABELS: Record<string, string> = {
    ...
    playerMerk: "Aansturing merk",
    playerType: "Aansturing type",
    playerSerienummer: "Aansturing serienummer",
    playerMac: "Aansturing MAC-adres",
    controllerMerk: "Controller merk",
    controllerType: "Controller type",
    controllerSerienummer: "Controller serienummer",
    controllerIp: "Controller IP-adres",
    ...
    // LED videowall e.d.
    afmeting: "Afmeting",
    cabinetAfmeting: "Cabinet-afmeting",
    resolutiePerCabinet: "Resolutie per cabinet",
    aantalCabinetten: "Aantal cabinetten",
    breedte: "Breedte",
    hoogte: "Hoogte",
